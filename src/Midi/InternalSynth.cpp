...
void 
CInternalSynth::NoteOff(uchar channel,
                          uchar note,
                          uchar velocity,
                          bigtime_t time)
{
...
void 
CInternalSynth::NoteOn(uchar channel,
                         uchar note,
                         uchar velocity,
                         bigtime_t time)
{
...
void 
CInternalSynth::KeyPressure(uchar channel,
                              uchar note,
                              uchar pressure,
                              bigtime_t time )
{
...
void 
CInternalSynth::ControlChange(uchar channel,
                                uchar controlNumber,
                                uchar controlValue,
                                bigtime_t time )
{
...
void 
CInternalSynth::ProgramChange(uchar channel,
                                uchar programNumber,
                                bigtime_t time)
{
...
void 
CInternalSynth::ChannelPressure(uchar channel,
                                  uchar pressure,
                                  bigtime_t time)
{
...
void 
CInternalSynth::PitchBend(uchar channel,
                            uchar lsb,
                            uchar msb,
                            bigtime_t time)
{
...
void 
CInternalSynth::SystemExclusive(void* data,
                                  size_t dataLength,
                                  bigtime_t time)
{
}
void 
CInternalSynth::SystemCommon(uchar statusByte,
                               uchar data1,
                               uchar data2,
                               bigtime_t time)
{
...
void 
CInternalSynth::SystemRealTime(uchar statusByte, bigtime_t time )
{
}
void 
CInternalSynth::TempoChange(int32 bpm, bigtime_t time = B_NOW)
{
}
